...
<script type="text/javascript">
	$('.tj').click(function(){
		...
		if(!major_id){
		 ...
		 $.ajax({url:"<?php echo U('add');?>",type:"post",data:{'stu_id':name,'major_id':major_id,'password':password,'realname':realname,'phone':phone,'email':email,'sex':sex},success:function(res){
		 		if(res.code == 1){
		 			layer.msg(res.msg, {
					  icon: 1,
