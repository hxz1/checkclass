...
<div class="page-container">
	...
	<span class="l">
		...
		<a href="javascript:;" onclick="member_add('添加课程','<?php echo U('add');?>','450','430')" class="btn btn-primary radius">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
				...
				<td><?php echo ($vo["tol_nums"]); ?></td>
				<td><?php echo ($vo["cla_place"]); ?></td>
				<td>星期<?php echo ($vo["weekdays"]); ?>&nbsp;&nbsp;第<?php echo ($vo["jieci"]); ?>节</td>
				...
				<a title="编辑" href="javascript:;" data-id="<?php echo ($vo["id"]); ?>" onclick="member_edit('编辑','http://www.checkclass.com/admin.php/class/edit/id/<?php echo ($vo["id"]); ?>','450','410')" class="ml-5" style="text-decoration:none">
