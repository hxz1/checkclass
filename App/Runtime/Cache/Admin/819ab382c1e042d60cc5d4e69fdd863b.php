...
<link rel="stylesheet" type="text/css" href="/CheckClass/Public/Admin/layer/2.4/skin/layer.css" />
<link rel="stylesheet" type="text/css" href="/CheckClass/Public/Admin/layui/css/layui.css" />
<title>添加选课</title>
</head>
<body>
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="请输入学生名字" id="stu_name" name="stu_name">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  placeholder="请输入老师名字" id="tea_name" name="tea_name">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="请输入课程名" id="class_name" name="class_name">
		</div>
	</div>
...
<script type="text/javascript" src="/CheckClass/Public/Admin/layui/layui.js"></script>
...
<script type="text/javascript">
	$('.tj').click(function(){
		...
		if(!class_name){
		 ...
		 $.ajax({url:"<?php echo U('add');?>",type:"post",data:{'stu_name':stu_name,'tea_name':tea_name,'class_name':class_name},success:function(res){
		 		if(res.code == 1){
		 			layer.msg(res.msg, {
					  icon: 1,
