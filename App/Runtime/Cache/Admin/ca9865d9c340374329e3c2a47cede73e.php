...
<nav class="breadcrumb">
	<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 学生管理 <span class="c-gray en">&gt;</span> 学生列表 
...
<div class="page-container">
	...
	<span class="l">
		...
		<a href="javascript:;" onclick="member_add('添加学生','<?php echo U('add');?>','450','400')" class="btn btn-primary radius">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
				...
				<a title="编辑" href="javascript:;" data-id="<?php echo ($vo["id"]); ?>" onclick="member_edit('编辑','http://www.checkclass.com/admin.php/student/edit/id/<?php echo ($vo["id"]); ?>','470','350')" class="ml-5" style="text-decoration:none">
					<i class="Hui-iconfont">&#xe6df;</i>
				</a>
				<a style="text-decoration:none" class="ml-5" onClick="change_password('修改密码','http://www.checkclass.com/admin.php/student/change_password/id/<?php echo ($vo["id"]); ?>',<?php echo ($vo["id"]); ?>,'400','270')" href="javascript:;" title="修改密码"><i class="Hui-iconfont">&#xe63f;</i></a> 
