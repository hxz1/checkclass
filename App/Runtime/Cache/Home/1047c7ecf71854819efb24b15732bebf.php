...
<ul id="ulStudMsgHeadTab">
    ...
    <li><a class="tab1" onclick="" href="<?php echo U('Index/edit');?>">修改信息</a> </li>
...
<div class="cztable">
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td width="260"><input type="text" value="<?php echo ($data1["realname"]); ?>" class="realname">&nbsp;</td>
            <td align="right" width="90">学号：</td>
            <td><?php echo ($data1["stu_id"]); ?>&nbsp;</td>
        </tr>
        <tr>
            <td align="right">性别：</td>
            <td><?php echo ($data1['sex']); ?>
            <!-- <?php if($data1['sex'] == '男'): ?><input name="sex" type="radio" id="sex-1" value="男" checked>男
                <input type="radio" id="sex-2" name="sex" value="女">女
            <?php elseif($data1['sex'] == '女'): ?>
            ...
            <td>
                <?php if($data1['major_id'] == ''): ?><select class="major">
                <option>请选择专业</option>
                  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value ="<?php echo ($vo["id"]); ?>" <?php if($data1['major_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
                </empty>
                <?php else: ?>
                <?php echo ($data1["name"]); endif; ?>
            </td>
        </tr>
        <tr>
            <td align="right">手机：</td>
            <td><input type="text" value="<?php echo ($data1["phone"]); ?>" class="phone">&nbsp;</td>
            <td align="right">邮箱：</td>
            <td><input type="text" value="<?php echo ($data1["email"]); ?>" class="email">&nbsp;</td>
        </tr>
        <tr>
            <td align="right">注册时间：</td>
            <td><?php echo (date("Y-m-d H:i:s",$data1["add_time"])); ?>&nbsp;</td>
            <td align="right">入学时间:</td>
            <td><?php echo (date("Y-m-d H:i:s",$data1["regis_time"])); ?></td>
        </tr>
        <tr>
