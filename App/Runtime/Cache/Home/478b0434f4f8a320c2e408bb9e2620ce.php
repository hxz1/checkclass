<?php if (!defined('THINK_PATH')) exit();?><link href="/Public/Home/css/reset.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="morebt" style="padding-top: 0px;">
        <ul>
            <li><a class="tab2" href="Application.aspx.html">热闻通知详情</a></li>
        </ul>
    </div>
    <div class="title">
    ...
    <div class="doc">
        ...
        <p style="float: right;">发布人：<?php echo ($data["author"]); ?></p>
        <p style="float: right;margin-top: 30px;margin-right: -94px;">发布时间：<?php echo (date("Y-m-d H:i:s",$data["add_time"])); ?></p>
