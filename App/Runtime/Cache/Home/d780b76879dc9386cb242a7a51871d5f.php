...
<ul id="ulStudMsgHeadTab">
    <li><a class="tab1" onclick="" href="<?php echo U('Teacher/index');?>">个人信息</a> </li>
    <li><a class="tab2" onclick="" href="<?php echo U('Teacher/edit');?>">修改信息</a> </li>
        ...
        <tr align="center">
            <td colspan="5" height="30">
                <div align="center">
                    ...
                    <input type="button" value="修改信息" class="btn btn-default" />
                    </a>
                </div>
            </td>
        </tr>
